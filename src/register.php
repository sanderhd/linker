...
<html lang="en">
    <head>
        ...
        <title>Register - Link Tracker</title>
        ...
        <nav class="mx-4 mt-6">
            <div class="max-w-5xl mx-auto bg-neutral-800/80 border border-white/10 rounded-2xl px-4 py-3 relative">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <a href="/links" class="absolute left-1/2 transform -translate-x-1/2 text-white/90 font-medium hover:underline hover:text-orange-500 transition">
                        Links
                    </a>
        ...
        <main class="flex items-center justify-center px-2 m-8" style="min-height: calc(100vh - 200px);">
            <div class="w-full max-w-md bg-neutral-800/50 border border-white/10 rounded-2xl px-12 py-10">
                <form action="register.php" method="POST">
                    <h1 class="text-white text-xl font-normal mb-6 text-center">Register</h1>
                    ...
                    ?>
                        <div class="mb-4 px-4 py-3 rounded-lg bg-<?php echo $bgColor; ?> border border-<?php echo $borderColor; ?> text-white flex items-center gap-3">
                    ...
                    <div class="mb-5">
                        <label for="email" class="block mb-2 text-white font-semibold text-sm">E-mail:</label>
                        <input 
                            type="email" 
                            id="email" 
                            name="email" 
                    ...
                    <div class="mb-8 relative">
                        <label for="confirm_password" class="block mb-2 text-white font-semibold text-sm">Confirm:</label>
                        <input 
                            type="password" 
                            id="confirm_password" 
                        ...
                        <button type="button" data-target="confirm_password" class="toggle-pass absolute right-3 top-10 text-white/40 hover:text-white transition">
                            <img src="assets/svg/eye.svg" class="w-5 h-5" />
                        </button>
                    </div>
                    ...
                    <p class="text-sm text-center text-white/40">
                        Already a member? 
                        <a href="login.php" class="text-orange-500 hover:underline">Log in now!</a>
                    </p>
                </form>
            </div>
        </main>
